# SAFEE
  ...
  Windows: set Mysql Port to 3306 in .env e config/database.php
  Mac: Using MAMP, set port to 8889

  First Use: change app/http/controller/auth/register construct method to
          $this->middleware('guess');
  and access localhost:8000/register to register a new user. Set user type to 0 (admin). After, change the above construct method to:
